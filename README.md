...
1.  Clone este repositório (ou simplesmente baixe os arquivos ZIP).
2.  Navegue até a pasta do projeto.
3.  Abra o arquivo `index.html` (ou `login.html`) diretamente no seu navegador de preferência (Google Chrome, Firefox, etc.).
...
* **`script.js` contém:**
    ...
    * A lógica para agrupar os produtos e injetar o HTML dinâm
        ico no `<main>`.
